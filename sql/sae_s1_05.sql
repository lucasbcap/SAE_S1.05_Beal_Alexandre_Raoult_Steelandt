...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 07 nov. 2022 à 11:32
...
INSERT INTO `serie` (id, titre, descriptif, img, genre, publicVise, annee, date_ajout)
VALUES (1, 'Le lac aux mystères',
        ...
        'lake.jpg', 'Horreur', 'Adulte', 2020, '2022-10-30'),
       (2, 'L\'eau a coulé',
        ...
        'water.jpg', 'Action', 'Adolescent', 1907, '2022-10-29'),
       (3, 'Chevaux fous', 'Une série sur la vie des chevals sauvages en liberté. Décoiffante.', 'horses.jpg',
        'Aventure', 'Famille', 2017, '2022-10-31'),
       (4, 'A la plage', 'Le succès de l\'été 2021, à regarder sans modération et entre amis.', 'beach.jpg', 'Aventure',
        'Famille', 2021, '2022-11-04'),
       (5, 'Champion',
        'La vie trépidante de deux champions de surf, passionnés dès leur plus jeune age. Ils consacrent leur vie à ce sport. ',
        'surf.jpg', 'Sport', 'Famille', 2022, '2022-11-03'),
       (6, 'Une ville la nuit',
        ...
        'carsbynight.jpg', 'Nostalgie', 'Adulte', 2017, '2022-10-31');
...
INSERT INTO `user` (`email`, `passwd`, `role`)
VALUES ('user1@mail.com', '$2y$12$e9DCiDKOGpVs9s.9u2ENEOiq7wGvx7sngyhPvKXo2mUbI3ulGWOdC', 1),
...
INSERT INTO `favori` (email, idSerie)
VALUES ('user1@mail.com', 1),
       ('user1@mail.com', 2),
       ('user1@mail.com', 4),
       ('user2@mail.com', 3),
       ('user2@mail.com', 5),
...
INSERT INTO `estVisionne` (email, idVideo)
VALUES ('user1@mail.com', 1),
       ('user1@mail.com', 2),
       ('user1@mail.com', 3),
       ('user1@mail.com', 4),
...
INSERT INTO `enCours` (email, idSerie)
VALUES ('user2@mail.com', 2);
...
INSERT INTO `estFini` (email, idSerie)
VALUES ('user1@mail.com', 1);
...
INSERT INTO `Commentaire` (comm, note, email, idSerie)
VALUES ('Le plot n\'est pas si intéréssant mais l\'action y est forte et prenante',3,'user1@mail.com', 1);
